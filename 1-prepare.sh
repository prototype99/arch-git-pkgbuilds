...
mkdir -p ${builddir}/pkgbuilds/{arch-packages,working-packages,working-packages-2}
cp -r $root/kde-git-pkgbuilds/* ${builddir}/pkgbuilds/working-packages
cp -r $root/git-pkgbuilds/* ${builddir}/pkgbuilds/working-packages-2
