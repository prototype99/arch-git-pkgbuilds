sed -i -r \
    ...
    -e 's/([^a-zA-Z0-9\-])oxygen-icons([^a-zA-Z0-9\-])/\1oxygen-icons-opt-git\2/' \
    ...
    -e 's/([^a-zA-Z0-9\-])oxygen([^a-zA-Z0-9\-])/\1oxygen-opt-git\2/' \
    ...
    -e 's/([^a-zA-Z0-9\-])oxygen-icons-svg([^a-zA-Z0-9\-])/\1oxygen-icons-svg-opt-git\2/' \
    -e 's/([^a-zA-Z0-9\-])phonon-qt4([^a-zA-Z0-9\-])/\1phonon-qt4-opt-git\2/' \
    -e 's/([^a-zA-Z0-9\-])plasma-wayland-session([^a-zA-Z0-9\-])/\1plasma-wayland-session-opt-git\2/' \
    -e 's/([^a-zA-Z0-9\-])oxygen-kde4([^a-zA-Z0-9\-])/\1oxygen-kde4-opt-git\2/' \
    -e 's/([^a-zA-Z0-9\-])knetattach([^a-zA-Z0-9\-])/\1knetattach-opt-git\2/' \
    -e 's/([^a-zA-Z0-9\-])breeze-kde4([^a-zA-Z0-9\-])/\1breeze-kde4-opt-git\2/' \
    -e 's/([^a-zA-Z0-9\-])phonon-qt4-gstreamer([^a-zA-Z0-9\-])/\1phonon-qt4-gstreamer-opt-git\2/' \
